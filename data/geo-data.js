...
// -------------------------------------------------------
const PROVINCES = [
  { id: '110000', name: '北京市',   shortName: '京' },
  { id: '120000', name: '天津市',   shortName: '津' },
  { id: '130000', name: '河北省',   shortName: '冀' },
  { id: '140000', name: '山西省',   shortName: '晋' },
  { id: '150000', name: '内蒙古自治区', shortName: '蒙' },
  { id: '210000', name: '辽宁省',   shortName: '辽' },
  { id: '220000', name: '吉林省',   shortName: '吉' },
  { id: '230000', name: '黑龙江省', shortName: '黑' },
  { id: '310000', name: '上海市',   shortName: '沪' },
  { id: '320000', name: '江苏省',   shortName: '苏' },
  { id: '330000', name: '浙江省',   shortName: '浙' },
  { id: '340000', name: '安徽省',   shortName: '皖' },
  { id: '350000', name: '福建省',   shortName: '闽' },
  { id: '360000', name: '江西省',   shortName: '赣' },
  { id: '370000', name: '山东省',   shortName: '鲁' },
  { id: '410000', name: '河南省',   shortName: '豫' },
  { id: '420000', name: '湖北省',   shortName: '鄂' },
  { id: '430000', name: '湖南省',   shortName: '湘' },
  { id: '440000', name: '广东省',   shortName: '粤' },
  { id: '450000', name: '广西壮族自治区', shortName: '桂' },
  { id: '460000', name: '海南省',   shortName: '琼' },
  { id: '500000', name: '重庆市',   shortName: '渝' },
  { id: '510000', name: '四川省',   shortName: '川' },
  { id: '520000', name: '贵州省',   shortName: '黔' },
  { id: '530000', name: '云南省',   shortName: '滇' },
  { id: '540000', name: '西藏自治区', shortName: '藏' },
  { id: '610000', name: '陕西省',   shortName: '陕' },
  { id: '620000', name: '甘肃省',   shortName: '甘' },
  { id: '630000', name: '青海省',   shortName: '青' },
  { id: '640000', name: '宁夏回族自治区', shortName: '宁' },
  { id: '650000', name: '新疆维吾尔自治区', shortName: '新' },
  { id: '710000', name: '台湾省',   shortName: '台' },
  { id: '810000', name: '香港特别行政区', shortName: '港' },
  { id: '820000', name: '澳门特别行政区', shortName: '澳' },
];

// -------------------------------------------------------
// 2. GB 码 → 省份名映射（GeoJSON GB 码的前两位）
// -------------------------------------------------------
const GB_TO_PROVINCE = {
  '11': '北京市',   '12': '天津市',   '13': '河北省',
  '14': '山西省',   '15': '内蒙古自治区',
  '21': '辽宁省',   '22': '吉林省',   '23': '黑龙江省',
  '31': '上海市',   '32': '江苏省',   '33': '浙江省',
  '34': '安徽省',   '35': '福建省',   '36': '江西省',
  '37': '山东省',
...
const CITY_PROVINCE_MAP = {
  ...
  '北屯市': '新疆维吾尔自治区', '铁门关市': '新疆维吾尔自治区',

  '台北市': '台湾省', '新北市': '台湾省', '桃园市': '台湾省',
  '台中市': '台湾省', '台南市': '台湾省', '高雄市': '台湾省',
...
/** 通过 GB 码前两位获取省份名 */
function getProvinceByGB(gbCode) {
  if (!gbCode || gbCode.length < 5) return null;
  const prefix = gbCode.substring(3, 5);
  return GB_TO_PROVINCE[prefix] || null;
}

/** 获取城市所属省份 */
function getProvinceOfCity(cityName) {
  if (CITY_PROVINCE_MAP[cityName]) return CITY_PROVINCE_MAP[cityName];
  const withoutSuffix = cityName.replace(/[市区]$/, '');
  if (CITY_PROVINCE_MAP[withoutSuffix]) return CITY_PROVINCE_MAP[withoutSuffix];
  if (CITY_PROVINCE_MAP[cityName + '市']) return CITY_PROVINCE_MAP[cityName + '市'];
  return null;
}

/** 获取某省下所有城市 */
function getCitiesOfProvince(provinceName) {
  return Object.entries(CITY_PROVINCE_MAP)
...
function searchCities(query) {
  ...
  const results = [];
  const seen = new Set();
  for (const [name, province] of Object.entries(CITY_PROVINCE_MAP)) {
    if (name.includes(q) && !seen.has(name)) {
      results.push({ name, province });
      seen.add(name);
    }
  }
